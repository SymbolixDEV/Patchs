...
class spell_putricide_ooze_eruption_searcher : public SpellScriptLoader
{
    public:
        ...
        class spell_putricide_ooze_eruption_searcher_SpellScript : public SpellScript
        {
            ...
            {
                uint32 adhesiveId = SPELL_VOLATILE_OOZE_ADHESIVE; //sSpellMgr->GetSpellIdForDifficulty(SPELL_VOLATILE_OOZE_ADHESIVE, GetCaster()); //MOP disable it
    ...
    public:
        ...
        class spell_putricide_unbound_plague_SpellScript : public SpellScript
        {
            ...
            void HandleScript(SpellEffIndex /*effIndex*/)
            {
                ...
                uint32 plagueId = SPELL_UNBOUND_PLAGUE;//sSpellMgr->GetSpellIdForDifficulty(SPELL_UNBOUND_PLAGUE, GetCaster());//MOP disable it
