...
public:
    ...
    static bool HandleLearnAllMyTalentsCommand(ChatHandler* handler, char const* /*args*/)
    {
        ...
        sLog->outError(LOG_FILTER_GENERAL, "HandleLearnAllMyTalentsCommand disabled, talent need fix");
        return true;
    }
    ...
    static bool HandleLearnAllMyPetTalentsCommand(ChatHandler* handler, char const* /*args*/)
    {
        ...
        sLog->outError(LOG_FILTER_GENERAL, "HandleLearnAllMyPetTalentsCommand disabled, talent need fix");
        return true;
    }
