...
// Achievement tooltip handler
$("[data-tip-achievement]").hover(
	function()
	{
		var $Id = parseInt($(this).attr("data-tip-achievement"));
		var $data = $('#achievement_tooltip_' + $Id);
		
		if (typeof $data != 'undefined' && $data.length > 0)
		{
			Tooltip.show($data.clone().css('display', 'block'));
		}
		else
		{
			Tooltip.show('Error.');
